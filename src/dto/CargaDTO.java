...
public class CargaDTO implements Serializable {
	...
	public CargaDTO(int idCarga, float peso, float ancho, float alto,
			float profundidad, float volumen, String fragilidad,
			String tratamiento, int apilable, boolean refrigerable,
			String condiciones, boolean despachado, String tipoMercaderia) {
		super();
